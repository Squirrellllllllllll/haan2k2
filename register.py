...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="anh2.jpg")
        bg=Label(self.root,image=self.bg).place(x=250,y=0,relwidth=1,relheight=1)
        
        #===Left Image====
        self.left=ImageTk.PhotoImage(file="anh5.png")
        ...
        btn_login=Button(self.root,text="Sign In",font=("times new roman",20),fg="grey",bd=2,cursor="hand2").place(x=300,y=540,width=180)
